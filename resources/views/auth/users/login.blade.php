    ...
    <x-auth-card>
        ...
        {{--        <form method="POST" action="{{ route('dang-nhap') }}">
                @csrf
                    ...
                    <!-- Email Address -->
                    <div>
                        <x-input id="email" placeholder="EMAIL" class="text-sm block mt-1 w-full" type="email" name="email"
                                 :value="old('email')" required autofocus/>
                    </div>

                    <!-- Password -->
                    <div class="mt-4">
                        <x-input id="password" class="text-sm block mt-1 w-full"
                                 type="password"
                                 name="password"
                    ...
                    <div class="block mt-4">
                        <label for="remember_me" class="inline-flex items-center">
                            <input id="remember_me" type="checkbox"
                                   class="square border-gray-300 text-indigo-600 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"
                                   name="remember">
